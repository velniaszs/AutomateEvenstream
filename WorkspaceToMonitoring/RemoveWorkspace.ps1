...
param(
    ...
    [Parameter(Mandatory = $false)]
    [string]$rmWorkspaceName = "ab_demo_4", #Name of the workspace to be removed

    [Parameter(Mandatory = $false)]
    [string]$rmWorkspaceId = "b7c510d6-c7fb-4311-a627-8c49f3f28933", #WorkspaceId of the workspace to be removed
